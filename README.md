...
Сделаны основные функции, для отображения данных, а так же накидана верстка. 

TODO: 
  1. Адаптивная верстка. Да тут придется много чего переделывать
  2. Рефакторинг кода на фронте.
