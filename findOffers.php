...
$cubature ='';
$model ='';
if(isset($_POST['cubature']) && isset($_POST['mark']) && isset($_POST['type']) && isset($_POST['model'])){
    $mark = $_POST['mark'];
    $type = $_POST['type'];
...
$sql_moto = "SELECT *  FROM $db_table_moto WHERE status='0' AND type='$type' AND mark='$mark' AND cubature='$cubature' AND nameMoto='$model'";
